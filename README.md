...
<details>
  ...
  <ol>
    ...
    <li><a href="#usage">Java Classes</a></li>
    <li><a href="#roadmap">User Interface</a></li>
    <li><a href="#contributing">Functionalities</a></li>
    <li><a href="#license">Issues</a></li>
...
* [Tensorflow 2.0.0rc0](https://www.tensorflow.org/install)
